...
#ifndef TRABAJO_PROGRESIONES_H
#define TRABAJO_PROGRESIONES_H
class Progression {
protected:
    long first;
    bool FirstTime = true;
...
public:
    ...
    bool operator!=(const GenProgressionIterator& rhs) {return cur <= rhs.cur;}
    GenProgressionIterator operator++() {
        cur = cur*base;
        return *this;
    }
    GenProgressionIterator operator++(int) {
        auto it = *this;
        ++*this;
        return it;
    }
...
public:
    ...
    bool operator!=(const FibonacciProgressionIterator& rhs) {return cur <= rhs.cur;}
    FibonacciProgressionIterator operator++() {
        long temp = cur;
        cur = cur+prev;
        prev = temp;
        return *this;
    }
    FibonacciProgressionIterator operator++(int) {
        auto it = *this;
        ++*this;
        return it;
    }
